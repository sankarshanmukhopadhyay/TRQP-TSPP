...
`TRQP-TSPP` is a Tier 1 flagship repository in the TRQP assurance stack. Its mandate is **security profile layer**. The repository is maintained as executable governance: material claims should map to artifacts, validation, evidence, and a reviewable change record.
...
- assurance-level control evidence

This repository is not authoritative for:

- the TRQP protocol specification
- cross-stack assurance publication
- general protocol conformance verdicts
